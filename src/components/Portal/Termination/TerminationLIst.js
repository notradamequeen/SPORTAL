...
class TerminationList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        };
...
export default connect(mapStateToProps, mapDispatchToProps)(TerminationList);
