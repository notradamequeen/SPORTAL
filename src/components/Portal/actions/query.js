...
export const qApplicationDetail = 'Select Id, Name, Applicant_Name__c, Applicant__r.Gender__c, Applicant__r.ID_Type__c, Applicant__r.ID_Number__c, \
Applicant__r.Nationality__c, Applicant__r.Other_Nationality__c, Applicant__r.Date_of_Birth__c, Applicant__r.Race__c, \
Applicant__r.Other_Race__c, Applicant__r.Marital_Status__c, Applicant__r.Other_Marital_Status__c, Street__c, Applicant__r.Id, \
